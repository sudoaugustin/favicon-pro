...
const parseHTML = (str => nodeHtmlParser.parse(str));

const fetchLinks = (url => fetch__default['default'](url).then(res => res.text()).then(parseHTML).then(html => html.querySelectorAll('head link')));
